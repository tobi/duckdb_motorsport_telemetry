...
The two example buttons fetch immutable, attributed MoTeC fixtures directly from the MIT-licensed [Friss/i3rs](https://github.com/Friss/i3rs) and Apache-2.0-licensed [JBonifay/motec-file-parser](https://github.com/JBonifay/motec-file-parser) repositories.
