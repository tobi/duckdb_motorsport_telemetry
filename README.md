...
```sh
curl -LO https://github.com/tobi/duckdb_motorsport_telemetry/releases/download/v0.5.0/motorsport_telemetry-linux_amd64.zip
...
```powershell
Invoke-WebRequest `
  https://github.com/tobi/duckdb_motorsport_telemetry/releases/download/v0.5.0/motorsport_telemetry-windows_amd64.zip `
